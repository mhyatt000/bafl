...
OXE_DATASET_CONFIGS = {
    "rlds_oakink": { # OAK INK Dataset
        ...
        "state_obs_keys": ['cam_intr','mano_pose','mano_shape','joints_3d','joints_vis'],
        "state_encoding": StateEncoding.HUMAN,
        "action_encoding": ActionEncoding.HUMAN,
    },
    #
    #
    #
